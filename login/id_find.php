...
<body>
    <div id="wrap">
    <h1><a href="../index.html" class="logo">한국천문학회</a></h1>
	<div id="col2">
			 ...
			 <div id="login2">
				<div id="id_input_button">
					<fieldset>
                        ...
                        <div class="telBox">
                            <label class="hidden" for="hp1">연락처 </label>
                    ...
                    <ul class="go">
                        ...
                        <li><div id="join_button">아직도 회원이 아니신가요?<a href="../member/member_form.php" class="go_join">회원가입</a></div></li>
                    </ul>
